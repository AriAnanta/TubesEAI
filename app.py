...
# Import compatibility patches first (before any other imports)
from common.patches import *
...
# Configure the app
service_name = "machine_queue"
port = int(os.getenv(f"{service_name.upper()}_PORT", 5003))
